...
pub fn get_router() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/user/:username/blog/page", get(posts_page))
        .route("/user/:username/blog/new", get(new_posts))
